...
- [x] **🎉 P-01 شغّال end-to-end (2026-06-24):** Docker Desktop + GPU passthrough (RTX 4050 داخل الحاوية) + 4 خدمات healthy (حينها؛ صارت 5 بعد إضافة `memory`) + Gemma 4 محمّل على GPU (~2.4GB) + طلب نجح عبر البوّابة (الموديل، سُمّي لاحقاً Sankari Chat → "2 + 2 equals 4"، مع reasoning). الواجهة على http://127.0.0.1:3000.
