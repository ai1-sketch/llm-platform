...
> **مالك المشروع ومنشئه (Project owner & creator): Ali Odeh.**
...
> - **بقايا قديمة في الجسم أدناه (لا تقرأها كوصف حالة):** أي ذكر لـ `llama.cpp`/`llama_cpp.server`/ملفات GGUF (المحرّك الآن **vLLM**)، أو "ثلاث حاويات" (الآن **5 خدمات**)، أو أرقام مقارنة مثل "~44x/TTFT>3د" — كلها سياق تاريخي/تعليمي، لا الحالة الراهنة.
