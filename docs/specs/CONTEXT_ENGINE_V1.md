...
> ⚠️ **متقاعد إلى فرع `future/context-engine` ([ADR-025](../DECISIONS.md)).** هذا المحرّك المخصّص **ليس على المسار الأساسي** — المسار الأساسي يعتمد ميزات Open WebUI المدمجة (RAG + Memory). هذه المواصفة محفوظة **كمرجع تصميمي** لتطوير مستقبلي؛ الكود الكامل (M0–M4b) على الفرع المذكور.
>
