...
- **التالي: M4** — الـ Orchestrator (assemble + ingest routing) + **ربط الـ LiteLLM hook** (حقن السياق في الدردشة فعلياً + التقاط أدوار المحادثة) — هنا تصير الذاكرة **مرئية للمستخدم**.
