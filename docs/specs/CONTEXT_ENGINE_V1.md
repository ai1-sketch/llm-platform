...
>
> هذا الملف هو **المرجع الحيّ** لبناء Context Engine: الآلية، المتطلّبات، وكيف نعمل خطوة-خطوة حتى لا نضيع. يُحدَّث بعد كل خطوة. مرجع القرار في [DECISIONS](../DECISIONS.md)، ونقطة الاستئناف العامة في [PROGRESS_MAP](../PROGRESS_MAP.md).
>
...
**الحالة الآن:** التصميم مكتمل ومُراجَع (ورشة 16 خبيراً + مراجعة عدائية). الوثائق (هذا الملف + ADR-019 + ADR-020) **مقترحة بانتظار اعتماد المالك**. **لا كود بعد.**
**التالي عند الاعتماد:** M0 (المتطلّبات المسبقة) → M1 …
