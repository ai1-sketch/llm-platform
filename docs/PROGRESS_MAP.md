...
> **آخر تحديث:** 2026-07-10 · **المحدِّث:** Chief Architect (الموجة A من التدقيق الخصمي — تقسية شبكة/امتياز + مواءمة حوكمة نصّ↔منفّذ [ADR-033](DECISIONS.md) + ترقية grafana من EOL — دُمجت على master؛ فوق طبقة الرصد ADR-031/032)
