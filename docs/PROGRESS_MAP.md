...
> **آخر تحديث:** 2026-07-09 · **المحدِّث:** Chief Architect (طبقة رصد الأداء Prometheus+Grafana [ADR-031](DECISIONS.md) دُمجت على master؛ + [ADR-032](DECISIONS.md) تأجيل مراقبة المحتوى؛ فوق إصلاحات Codex)
